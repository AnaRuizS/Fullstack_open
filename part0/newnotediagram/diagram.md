...
sequenceDiagram
    ...
    Note right of server: The server creates a new note object and adds it to the array "notes." Then, the server asks the browser to perform a URL redirect to the location defined on the header ("/notes").
